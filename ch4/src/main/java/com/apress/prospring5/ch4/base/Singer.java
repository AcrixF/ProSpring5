package com.apress.prospring5.ch4.base;
...
public class Singer {
    ...
    private static final String DEFAULT_NAME = "Nitzine Esmeralda Ocampo Avila";
    ...
    public static void main( String [] args ) {
        ...
        Singer s1 = getBean("singerOne", ctx);
        Singer s2 = getBean("singerTwo", ctx);
        Singer s3 = getBean("singerThree", ctx);
